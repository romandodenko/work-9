...
const heroBottomLeft = document.querySelector(".hero__bottom-left");

const heroBottom = document.querySelector(".hero__bottom");

const heroImageOne = document.querySelector(".hero__image_1");

const heroImageTwo = document.querySelector(".hero__image_2");

if(heroBottomLeft && heroBottom) {
   
  if (document.body.clientWidth < 992) {
    heroBottomLeft.append(heroImageOne);
    heroBottom.append(heroImageTwo);
  }
