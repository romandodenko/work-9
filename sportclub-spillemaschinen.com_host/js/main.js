...
const footerRight = document.querySelector(".footer__bottom-right");

if (footerIcons && footerIcons) {

  if (document.body.clientWidth < 992) {
    footerRight.append(footerIcons);
  }
...
if (header) {
  ...
  if (terms) {
    terms.style.paddingTop = (headerHeight + 52) + "px";
  }

  if (game) {
    game.style.paddingTop = (headerHeight + 52) + "px";
  }
}