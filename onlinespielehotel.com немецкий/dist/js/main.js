...
const gamesItem = document.querySelectorAll(".games__item");

if (gamesItem) {

  if (document.body.clientWidth < 669) {
    gamesItem.forEach(function (e) {
      let gamesName = e.querySelector('.games__name');
