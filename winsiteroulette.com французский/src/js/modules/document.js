...
const vitrineSlide = document.querySelector(".vitrine-slide");

if (vitrineSlide) {
  const vitrineSwiper = new Swiper(vitrineSlide, { 
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: "auto",
    ...
    pagination: {
      el: '.vitrine-slide-pagination',
      clickable: true, 
    },
    navigation: {
      nextEl: '.vitrine-slide-next',
      prevEl: '.vitrine-slide-prev',
    }, 
  });
}