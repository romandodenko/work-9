...
const feierSlider = document.querySelector(".feier-slider");

if(feierSlider) {
  const feierSwiper = new Swiper(feierSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    navigation: {
      nextEl: '.feier-slider-next',
      prevEl: '.feier-slider-prev',
    },
    pagination: {
      el: '.feier-slider-pagination',
      clickable: true, 
    },
  });
}
