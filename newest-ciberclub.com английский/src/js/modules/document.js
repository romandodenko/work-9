...
const accommodationSlider = document.querySelector(".accommodation-slider");

if (accommodationSlider) {
  const accommodationSwiper = new Swiper(accommodationSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    pagination: {
      el: '.accommodation-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.accommodation-slider-next',
      prevEl: '.accommodation-slider-prev',
    },
  });
