...
if(heroList && heroLeft) {
  const heroListStyles = heroList.getBoundingClientRect();

  const heroListHeight = heroListStyles.height;

  if (document.body.clientWidth > 992) {
    heroLeft.style.paddingBottom = (heroListHeight + 16) + "px";
  }
