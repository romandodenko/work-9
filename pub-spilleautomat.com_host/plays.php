 ...
 <body>
   <div class="page">
     ...
     <main>
       ...
       <section class="block">
         <div class="container">
           <h1 class="block__title tt-52-34">
             Spillerum
           </h1> 
           <ul class="block__images">
             <li class="block__image">
               <picture>
                 ...
                 <img src="./img/slot-1.jpg" loading="lazy" width="336" height="336" alt="Spillerum">
               </picture>
             </li>
             <li class="block__image">
               <picture>
                 <source media="(min-width: 320px)" srcset="./img/slot-2.webp" type="image/webp">
                 <img src="./img/slot-2.jpg" loading="lazy" width="336" height="336" alt="Spillerum">
               </picture>
             </li>
           </ul>
           <div class="block__descr">
             <div class="block__texts">
               <p class="block__text tx-24-18">
                 Spillerummet er et unikt sted, hvor du kan nyde de hotteste, bedste og første spilleautomater.
               </p>
               <p class="block__text tx-24-18">
                 Hvis du elsker gambling og ønsker at få et adrenalinsus, så er dette spillelokale det perfekte sted
                 for dig.
               </p>
               <p class="block__text tx-24-18">
                 De nyeste og mest populære spilleautomater fra førende producenter venter på dig.
               </p>
               <p class="block__text tx-24-18">
                 De tilbyder en række spil og temaer, der passer til enhver smag.
               </p>
               <p class="block__text tx-24-18">
                 Disse hotte slots er skabt ved hjælp af den nyeste teknologi og giver maksimal komfort og fornøjelse
                 af spillet.
               </p>
               <p class="block__text tx-24-18">
                 Vi tilbyder også en hyggelig og elegant atmosfære for dig og dine venner.
               </p>
               <p class="block__text tx-24-18">
                 Du kan nyde spillet i et behageligt miljø, og det professionelle personale vil med glæde hjælpe og
                 rådgive dig, hvis det er nødvendigt.
               </p>
             </div>
           </div> 
         </div>
