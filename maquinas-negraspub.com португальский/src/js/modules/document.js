...
if (headerContainer) {
  ...
  if (heroContainer) {
    const heroContainerStyles = heroContainer.getBoundingClientRect();
    const heroContainerHeight = heroContainerStyles.height;

    if (document.body.clientWidth > 992) {
      headerContainer.style.height = heroContainerHeight + "px";
    }
  }
