...
document.addEventListener("click", function (e) {
  ...
  if (elementInteractive.closest(".header-menu__exit")) { // Открытие и закрытие бургера 
...
const restaurantLeftTop = document.querySelector(".restaurant__left-top");

const restaurantSubtitle = document.querySelector(".restaurant__subtitle");

if(restaurantLeftTop && restaurantSubtitle) {

  if (document.body.clientWidth < 992) {
    restaurantLeftTop.append(restaurantSubtitle); 
  }
