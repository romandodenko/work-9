  ...
  <div class="page">
    ...
    <main>
      ...
      <section class="game rd-upload">
        <div class="container">
          <h1 class="game__title tt-52-34">
            Rainbow riches
          </h1>
          <div class="game__map">
            <iframe src="https://dnk-resource.wimobile.casinarena.com/resource-service/game.html?game=rainbowriches_prt&partnercode=mockpartner&realmoney=false&gaffing=true&demo=true"></iframe>
          </div>
        </div>
      </section>
      <!-- end game -->
