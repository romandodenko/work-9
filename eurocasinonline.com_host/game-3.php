  ...
  <div class="page">
    ...
    <main>
      ...
      <section class="slot rd-upload">
        <div class="container">
          <h1 class="slot__title tt-53-46">
            Rainbow reels
          </h1>
          <div class="slot__game">
            <iframe src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs40rainbowr&lang=en&lobbyUrl=https://vavadafgg.com/ru/games/exit&cashierUrl=https://vavadafgg.com/ru/profile/deposit/&stylename=sfws_vavada&jurisdiction=99&isGameUrlApiCalled=true"></iframe>
          </div>
        </div>
      </section>
      <!-- end slot -->
