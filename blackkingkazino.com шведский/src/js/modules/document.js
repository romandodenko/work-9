...
const boendeSlider = document.querySelector(".boende-slider");

if(boendeSlider) {
  const boendeSwiper = new Swiper(boendeSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    pagination: {
      el: '.boende-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.boende-slider-next',
      prevEl: '.boende-slider-prev',
    },
  });
} 