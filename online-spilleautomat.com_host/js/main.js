...
if (header) {
  ...
  if (heroContainer) {
    heroContainer.style.paddingTop = (headerHeight + 24) + "px";
    heroContainer.style.paddingBottom = (headerHeight + 24) + "px";
  }

  if (slots) {
    slots.style.paddingTop = (headerHeight + 80) + "px";
  }

  if (terms) {
    terms.style.paddingTop = (headerHeight + 80) + "px";
  }

  if (contacts) {
    contacts.style.paddingTop = (headerHeight + 80) + "px";
  }
}
// };