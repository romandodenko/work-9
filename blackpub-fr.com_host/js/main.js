...
const vitrineSlider = document.querySelector(".vitrine-slider");

if (vitrineSlider) {
  const vitrineSwiper = new Swiper(vitrineSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    pagination: {
      el: '.vitrine-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.vitrine-slider-next',
      prevEl: '.vitrine-slider-prev',
    },
  });
}