 ...
 <body>
   <div class="page">
     ...
     <main>
       <!-- start slot -->
       <section class="eventos eventos_padding-top rd-upload">
         <div class="container">
           <h1 class="eventos__title tt-42-30">
             Sala de juego
           </h1>
           <div class="eventos__texts">
             <p class="eventos__text tx-16-14">
               El "Sala de juego" del Hotel Montevideo es un impresionante espacio donde los huéspedes podrán vivir emoción
               y diversión. Hay una variedad de máquinas tragamonedas y juegos emocionantes que aumentarán tu adrenalina
               y te harán sentir la atmósfera del entretenimiento del juego. La “Sala de juego” del Hotel Montevideo
               seguramente será uno de los mejores lugares para los amantes de la suerte, donde podrán sumergirse en el
               apasionante mundo de los juegos de azar y vivir emociones inigualables. Independientemente de tu
               experiencia de juego, la sala de tragamonedas del Hotel Montevideo te brindará momentos inolvidables y
